...
<div id="wrapper">
  <div class="container">
    ...
    <div class="switcher">
      ...
      <div class="bg"></div>
      <div class="text">Ligar <span class="text-l">On</span><span class="text-d">Off</span><br />Luz</div>
    </div>
    <!-- End Switcher -->
    ...
    <div id="light" class="row text-center">
      ...
      <div class="info">
        ...
        <!-- end Rabbit -->
        <p>A página que você procura foi movida, removida<br />
          renomeada ou talvez nunca existiu.</p>
