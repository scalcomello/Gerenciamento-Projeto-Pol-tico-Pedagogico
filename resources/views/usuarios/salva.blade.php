                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($disciplina as $rows)
                                @if($rows->periodo == $j)
                                    <tr>
                                        <td>{{$i.'.'}}</td>
                                        <td><a href=" ">{{$rows->disciplina->nome}}</a></td>
                                        <td width="80">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group{{ $errors->has('disciplinas_id') ? ' has-error' : '' }}">
                            {!!  Form::label('disciplinas_id','Nome',array('class' => 'col-sm-2 control-label')) !!}
                            <div class="col-sm-6">
                        ...
                        <div class="form-group{{ $errors->has('ch') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-3">
                                {!! Form::input('text','ch',old('ch'),array('class' => 'form-control','placeholder' => 'Carga Horária'))!!}
                                @if ($errors->has('ch'))
                        ...
                        <div class="form-group{{ $errors->has('qtd_aula') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-3">
                                {!! Form::input('text','qtd_aula',old('qtd_aula'),array('class' => 'form-control','placeholder' => 'Carga Horária'))!!}
                        ...
                        <div class="form-group{{ $errors->has('periodo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-6">
                                <select class="control-label" name="periodo"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group{{ $errors->has('disciplina') ? ' has-error' : '' }}">
                                {!!  Form::label('disciplina','Disciplina',array('class' => 'col-sm-4 control-label')) !!}
                                <div class="col-sm-8">
                                    {!! Form::input('text','disciplina',old('disciplina'),array('class' => 'form-control','placeholder' => 'Disciplina'))!!}
                                    @if ($errors->has('disciplina'))
                                        <span class="help-block"><strong>{{ $errors->first('disciplina') }}</strong></span>
                                    @endif
                                </div>
                            </div>
