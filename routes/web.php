...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::group(['as' => 'caracterizacao.', 'prefix' => 'caracterizacao_institucional'], function () {
        // identificacao
        Route::get('/identificacao', ['uses' => 'Caracterizacao_institucionalController@index', 'as' => 'index']);
    ...
    Route::group(['as' => 'curso.', 'prefix' => 'cursos'], function () {
        ...
        Route::get('novo', ['uses' => 'CursoController@form', 'as' => 'form']);
        Route::post('salvar', ['uses' => 'CursoController@store', 'as' => 'store']);
        ...
        Route::get('{denominacao}/gerenciar/estrutura_curricular', ['uses' => 'Estrutura_curricularController@index', 'as' => 'index']);
        ...
        //Corpo Docente
        Route::get('{curso}/gerenciar/corpo_docente', ['uses' => 'Corpo_docenteController@index', 'as' => 'index']);
        ...
        Route::get('{id}/gerenciar/estrutura_curricular/{iddisp}/ementario', ['uses' => 'EmentarioController@index', 'as' => 'index']);
